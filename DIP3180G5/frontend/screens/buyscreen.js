...
export default function BuyScreen({ route }) {
  ...
  return (
    ...
    <View style={globalStyles.container}>
      <Card>
      <Image
        source={{ uri: route.params.imageURLs[0] }} // Set the source prop to the image URL
        style={{
      ...
      <Text style={globalStyles.itemText}>Registration Date: { route.params.registrationDate }</Text>
      <Text style={globalStyles.itemText}>COE Left: { route.params.yearsOfCOELeft } years</Text>
