...
const NotificationMain = ({ navigation }) => {
        ...
        <View style={styles.side}>
          ...
          <ScrollView style={styles.scrollView}>
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate("NotificationOutbid")}
            >
            ...
            >
              <View style={styles.notificationtext}>
                ...
                <Text style={styles.name}>Successful Bidding for Ford X</Text>
                <Text style={{ paddingTop: 5, color: "grey" }}>
                  We regret to inform you that you have been outbid for an
                  ongoing auction of [Insert Item].
                </Text>
